...
| Branch Sinuosity                     | _idem_               | The sinuosity of a spot during its life span (cf. [Sinuosity](https://en.wikipedia.org/wiki/Sinuosity)), i.e. how much the track represented by the branch is curved. Values close to 1: almost straight movement. Values significantly higher than 1: winding or meandering movement. Positive infinity (∞), if the spot is at the end at the same position as at the beginning, but has moved in between. Example visualization: ![branchSinuosityAnimation.gif](doc/features/branch/ranchSinuosityAnimation.gif) | ![](doc/features/branch/branchSinuosityEquation.gif)                                                                                  |
| Branch Average Movement              | _idem_               | The average movement per frame of a spot during its life span. Example visualization: ![average_movement_animation.gif](doc/features/branch/branchAverageMovementAnimation.gif)                                                                                                                                                                                                                                                                                                                                     | ![](doc/features/branch/branchAverageMovementEquation.gif) <br><br> e.g.: <br><br> ![](doc/features/branch/branchAverageMovement.png) |
...
* Exporter can be found here:  ![Plugin Export Menu](doc/export/label_image/plugin_export_menu.png)
...
* Exporter can be found here:  ![Plugin Export Dialog](doc/export/graphml/plugin_export_menu.png)
