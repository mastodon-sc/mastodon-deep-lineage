...
| Spot Relative Movement*      | x, y and z component                              | The x, y and z component of spot movement relative to its nearest neighbors. The number of neighbors to be considered can be specified by the user. Default is 5. | ![](/doc/deep_lineage/features/spotRelativeMovementEquation1.gif)                                                      |
|                              | norm                                              | The norm of spot movement relative to nearest neighbors.                                                                                                          | ![](/doc/deep_lineage/features/spotRelativeMovementEquation2.gif)                                                      |
...
| Branch Sinuosity                     | _idem_          | The sinuosity of a spot during its life cycle (cf. [Sinuosity](https://en.wikipedia.org/wiki/Sinuosity)), i.e. how much the track represented by the branch is curved. Values close to 1: almost straight movement. Values significantly higher than 1: winding or meandering movement. | ![](/doc/deep_lineage/features/sinuosityEquation.gif) <br><br> i.e.: <br><br> ![](/doc/deep_lineage/features/sinuosityEquation2.gif)                                                                                                            |
| Branch Average Movement              | _idem_          | The average movement per frame of a spot during its life cycle.                                                                                                                                                                                                                         | ![](/doc/deep_lineage/features/branchAverageMovementEquation1.png) <br><br> i.e.: <br><br> ![](/doc/deep_lineage/features/branchAverageMovementEquation2.png) <br><br> e.g.: <br><br> ![](/doc/deep_lineage/features/branchAverageMovement.png) |
...
| Branch Relative Movement*            | x, y and z component | The normalized direction of the average movement of a spot during its life cycle in relation to its nearest neighbors. The number of neighbors to be considered can be specified by the users. Default is 5.                                                                            | ![](/doc/deep_lineage/features/branchRelativeMovementEquation1.gif)                                                                                  |
|                                      | norm                 | The norm of the average movement of a spot during its life cycle in relation to its nearest neighbors.                                                                                                                                                                                  | ![](/doc/deep_lineage/features/branchRelativeMovementEquation2.gif)                                                                                  |
