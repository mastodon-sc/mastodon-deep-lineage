...
|                              | Volume                                            | The volume of the ellipsoid.                                                                                                                                                              | ![](/doc/deep_lineage/features/spotVolume.gif)                                                                         |
| Spot Ellipsoid Aspect Ratios | Aspect ratio short to middle                      | The ratio between the short axis and middle axis.                                                                                                                                         | ![](/doc/deep_lineage/features/spotShortMiddleAxis.gif)                                                                |
|                              | Aspect ratio short to long                        | The ratio between the short axis and long axis.                                                                                                                                           | ![](/doc/deep_lineage/features/spotShortLongAxis.gif)                                                                  |
|                              | Aspect ratio middle to long                       | The ratio between the middle axis and long axis.                                                                                                                                          | ![](/doc/deep_lineage/features/spotMiddleLongAxis.gif)                                                                 |
...
| Branch Sinuosity                     | _idem_               | The sinuosity of a spot during its life cycle (cf. [Sinuosity](https://en.wikipedia.org/wiki/Sinuosity)), i.e. how much the track represented by the branch is curved. Values close to 1: almost straight movement. Values significantly higher than 1: winding or meandering movement. | ![](/doc/deep_lineage/features/branchSinuosityEquation.gif)                                                                                         |
