...
public class GeometryUtilTest
{
	...
	public void testGetEuclideanDistance()
	{
		...
		assertEquals( Math.sqrt( 8d ), GeometryUtil.getEuclideanDistance( new double[] { 0d, 0d }, new double[] { 2d, 2d } ), 0d );
		assertEquals( Math.sqrt( 12d ), GeometryUtil.getEuclideanDistance( new double[] { 0d, 0d, 0d }, new double[] { 2d, 2d, 2d } ), 0d );
		assertEquals( 4d, GeometryUtil.getEuclideanDistance( new double[] { 0d, 0d, 0d, 0d }, new double[] { 2d, 2d, 2d, 2d } ), 0d );
	}
}
