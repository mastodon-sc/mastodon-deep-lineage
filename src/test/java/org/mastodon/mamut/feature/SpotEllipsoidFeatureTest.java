...
public class SpotEllipsoidFeatureTest
{
	...
	public void testEllipsoidFeature()
	{
		try(Context context = new Context())
		{
			...
			// compute features
			FeatureProjection< Spot > featureProjectionAxisA = FeatureComputerTestUtils.getSpotFeatureProjection( context, exampleGraph3, SpotEllipsoidFeature.SPEC, SpotEllipsoidFeature.AXIS_A_PROJECTION_SPEC, sharedBigDataViewerData );
			FeatureProjection< Spot > featureProjectionAxisB = FeatureComputerTestUtils.getSpotFeatureProjection( context, exampleGraph3, SpotEllipsoidFeature.SPEC, SpotEllipsoidFeature.AXIS_B_PROJECTION_SPEC, sharedBigDataViewerData );
			FeatureProjection< Spot > featureProjectionAxisC = FeatureComputerTestUtils.getSpotFeatureProjection( context, exampleGraph3, SpotEllipsoidFeature.SPEC, SpotEllipsoidFeature.AXIS_C_PROJECTION_SPEC, sharedBigDataViewerData );
			FeatureProjection< Spot > featureProjectionVolume = FeatureComputerTestUtils.getSpotFeatureProjection( context, exampleGraph3, SpotEllipsoidFeature.SPEC, SpotEllipsoidFeature.VOLUME_PROJECTION_SPEC, sharedBigDataViewerData );
