...
{
	private final Path tinyExampleProject = resourceAsFile( "/org/mastodon/mamut/linking/trackastra/tgmm-mini_27_31.mastodon" );

	private final Context context = new Context();

	@Test
	void testLinking() throws IOException, SpimDataException, NoSuchFieldException, IllegalAccessException
	{
