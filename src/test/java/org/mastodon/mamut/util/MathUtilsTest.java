...
class MathUtilsTest
{
	...
	void testRoundToSignificantDigits()
	{
		...
		assertEquals( "1.235".replace( '.', decimalSeparator ), MathUtils.roundToSignificantDigits( 1.2345678, 4 ) );
		assertEquals( "0.000123".replace( '.', decimalSeparator ), MathUtils.roundToSignificantDigits( 0.00012345678, 3 ) );
		assertEquals( "0.6".replace( '.', decimalSeparator ), MathUtils.roundToSignificantDigits( 0.5678, 1 ) );
	}
